    ...
    <div class="span5">
        <div class="logo">
            <a href="http://localhost:8080/mango/">
                <img src="${pageContext.request.contextPath}/static/image/r___________renleipic_01/logo.gif" alt="传智播客">
            </a>
        </div>
    </div>
    <div class="span9">
        ...
        <div class="topNav clearfix">
            <ul>
                ...
                <li id="headerLogout" class="headerLogout">
                    <a href="${pageContext.request.contextPath}/index.do">[退出]</a>|
                </li>
                <li>
                    <a>会员中心</a>
                    |
										...
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha"
                                                   maxlength="4" autocomplete="off"><img id="captchaImage"
                                                                                         class="captchaImage"
                                                                                         src="${pageContext.request.contextPath}/static/image/captcha.jhtml"
                                                                                         title="点击更换验证码">
										</span>
                            </td>
                        </tr>
...
<div class="container footer">
    <div class="span24">
        <div class="footerAd">
            <img src="${pageContext.request.contextPath}/static/image/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势">
        </div>
    </div>
    <div class="span24">
        <ul class="bottomNav">
